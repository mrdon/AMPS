...
public class UserFormatModuleCreator extends AbstractPluginModuleCreator<UserFormatProperties> {
    ...
    private static final String FUNC_TEST_TEMPLATE = TEMPLATE_PREFIX + "UserFormatFuncTest.java.vtl";
    ...
    @Override
    public void createModule(PluginModuleLocation location, UserFormatProperties props) throws Exception {
