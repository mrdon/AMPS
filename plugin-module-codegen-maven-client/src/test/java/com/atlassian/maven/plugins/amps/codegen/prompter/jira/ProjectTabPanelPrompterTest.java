...
public class ProjectTabPanelPrompterTest extends AbstractPrompterTest
{
    ...
    public static final String MODULE_KEY = "my-project-tab-panel";
    public static final String DESCRIPTION = "The My Project Tab Panel Plugin";
    public static final String I18N_NAME_KEY = "my-project-tab-panel.name";
    public static final String I18N_DESCRIPTION_KEY = "my-project-tab-panel.description";
