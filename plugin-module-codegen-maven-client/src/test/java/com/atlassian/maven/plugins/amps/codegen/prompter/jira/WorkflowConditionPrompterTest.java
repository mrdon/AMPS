...
public class WorkflowConditionPrompterTest extends AbstractPrompterTest
{
    ...
    public static final String CLASSNAME = "MyWorkflowCondition";
    public static final String FACTORY_CLASSNAME = "MyWorkflowConditionFactory";
    public static final String MODULE_NAME = "My Workflow Condition";
    public static final String MODULE_KEY = "my-workflow-condition";
    public static final String DESCRIPTION = "The My Workflow Condition Plugin";
    public static final String I18N_NAME_KEY = "my-workflow-condition.name";
    public static final String I18N_DESCRIPTION_KEY = "my-workflow-condition.description";
    ...
    {
        when(prompter.prompt("Enter New Classname", "MyWorkflowCondition")).thenReturn(CLASSNAME);
