 ...
 * @since 3.6
 */
public class ComponentTabPanelPrompterTest extends AbstractPrompterTest
{
    public static final String PACKAGE = "com.atlassian.plugins.jira.tabpanels";
    public static final String CLASSNAME = "MyComponentTabPanel";
    public static final String MODULE_NAME = "My Component Tab Panel";
    public static final String MODULE_KEY = "my-component-tab-panel";
    public static final String DESCRIPTION = "The My Component Tab Panel Plugin";
    public static final String I18N_NAME_KEY = "my-component-tab-panel.name";
    public static final String I18N_DESCRIPTION_KEY = "my-component-tab-panel.description";
    ...
    {
        when(prompter.prompt("Use " + ComponentTabPanelModuleCreator.GENERIC_CLASS + "?", PluginModulePrompter.YN_ANSWERS, "Y")).thenReturn("n");
        when(prompter.prompt("Enter New Classname", "MyComponentTabPanel")).thenReturn(CLASSNAME);
        ...
        ComponentTabPanelPrompter modulePrompter = new ComponentTabPanelPrompter(prompter);
    ...
    {
        when(prompter.prompt("Use " + ComponentTabPanelModuleCreator.GENERIC_CLASS + "?", PluginModulePrompter.YN_ANSWERS, "Y")).thenReturn("y");
        when(prompter.prompt("Enter Plugin Module Name", "My Component Tab Panel")).thenReturn(MODULE_NAME);
        when(prompter.prompt("Show Advanced Setup?", PluginModulePrompter.YN_ANSWERS, "N")).thenReturn("N");
        when(prompter.prompt("Include Example Code?", PluginModulePrompter.YN_ANSWERS, "N")).thenReturn("N");
        ...
        assertEquals("wrong class", ComponentTabPanelModuleCreator.GENERIC_CLASS, props.getClassname());
        assertEquals("wrong class package", ComponentTabPanelModuleCreator.GENERIC_PACKAGE, props.getPackage());
        assertEquals("wrong module name", MODULE_NAME, props.getModuleName());
        assertEquals("wrong module key", MODULE_KEY, props.getModuleKey());
        assertEquals("wrong description", DESCRIPTION, props.getDescription());
        assertEquals("wrong i18n name key", I18N_NAME_KEY, props.getNameI18nKey());
    ...
    {
        when(prompter.prompt("Use " + ComponentTabPanelModuleCreator.GENERIC_CLASS + "?", PluginModulePrompter.YN_ANSWERS, "Y")).thenReturn("y");
        when(prompter.prompt("Enter Plugin Module Name", "My Component Tab Panel")).thenReturn(ADV_MODULE_NAME);
        when(prompter.prompt("Show Advanced Setup?", PluginModulePrompter.YN_ANSWERS, "N")).thenReturn("y");

        when(prompter.prompt(MODULE_KEY_PROMPT, "my-awesome-plugin")).thenReturn(ADV_MODULE_KEY);
        when(prompter.prompt(MODULE_DESCRIP_PROMPT, "The My Awesome Plugin Plugin")).thenReturn(ADV_DESCRIPTION);
        ...
        assertEquals("wrong adv class", ComponentTabPanelModuleCreator.GENERIC_CLASS, props.getClassname());
        assertEquals("wrong adv class package", ComponentTabPanelModuleCreator.GENERIC_PACKAGE, props.getPackage());
        assertEquals("wrong adv module name", ADV_MODULE_NAME, props.getModuleName());
        assertEquals("wrong adv module key", ADV_MODULE_KEY, props.getModuleKey());
        assertEquals("wrong adv description", ADV_DESCRIPTION, props.getDescription());
        assertEquals("wrong adv i18n name key", ADV_I18N_NAME_KEY, props.getNameI18nKey());
