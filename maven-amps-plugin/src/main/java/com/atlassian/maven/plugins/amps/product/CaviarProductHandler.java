...
public class CaviarProductHandler extends AbstractWebappProductHandler
{
    ...
    {
        return new ProductArtifact("com.atlassian.caviar", "caviar-webapp", "LATEST");
    }
...
/*
    ...
    {
        String bundledPluginPluginsPath = "WEB-INF/classes/caviar-bundled-plugins-1.0-SNAPSHOT.zip";
