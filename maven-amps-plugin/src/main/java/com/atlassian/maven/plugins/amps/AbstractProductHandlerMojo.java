...
public abstract class AbstractProductHandlerMojo extends AbstractProductHandlerAwareMojo {
    ...
    /**
     * Returns the Product objects that are defined in our maven-amps2-plugins object:
     * <ul>
     ...
     * <ul>
     * <li>The {@literal <product>} from the maven-amps2-plugin configuration (if missing, RefApp is used)</li>
     * <li>The {@literal <products>} from the maven-amps2-plugin configuration</li>
     * </ul>
     */
