...
public class WebworkPrompterTest extends AbstractPrompterTest {
    ...
    public void basicPropertiesAreValid() throws PrompterException {
        ...
        assertEquals("wrong number of actions",1,props.getActions().size());

        ActionProperties action = props.getActions().get(0);
        ...
        assertEquals("wrong number of views",3,action.getViews().size());
        View success = action.getViews().get(0);
        View input = action.getViews().get(1);
        View error = action.getViews().get(2);
    ...
    public void advancedPropertiesAreValid() throws PrompterException {
        ...
        when(prompter.prompt("Enter Action Classname", "MyActionClass")).thenReturn(CUSTOM_ACTION_ONE_NAME).thenReturn(CUSTOM_ACTION_TWO_NAME);
        ...
        when(prompter.prompt("Enter View Name","success")).thenReturn(SUCCESS_VIEW_NAME).thenReturn(ERROR_VIEW_NAME).thenReturn(CUSTOM_VIEW_NAME);
        ...
        when(prompter.prompt("Add Another Action?", PluginModulePrompter.YN_ANSWERS, "N")).thenReturn("Y").thenReturn("N");
        when(prompter.prompt("Add Another View?", PluginModulePrompter.YN_ANSWERS, "N")).thenReturn("Y").thenReturn("N");
        ...
        assertEquals("wrong number of actions",2,props.getActions().size());

        ActionProperties actionOne = props.getActions().get(0);
        ActionProperties actionTwo = props.getActions().get(1);
        ...
        assertEquals("wrong number of action one views",2,actionOne.getViews().size());
        View success = actionOne.getViews().get(0);
        View error = actionOne.getViews().get(1);
        ...
        assertEquals("wrong number of action one views",1,actionTwo.getViews().size());
        View custom = actionTwo.getViews().get(0);
