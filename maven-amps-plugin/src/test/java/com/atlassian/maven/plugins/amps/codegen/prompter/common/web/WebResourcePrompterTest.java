...
public class WebResourcePrompterTest extends AbstractPrompterTest {
    ...
    public void basicPropertiesAreValid() throws PrompterException {
        ...
        when(prompter.prompt("Enter Resource Type", "download")).thenReturn(DOWNLOAD_TYPE).thenReturn(VELOCITY_TYPE);
    ...
    public void advancedPropertiesAreValid() throws PrompterException {
        ...
        when(prompter.prompt("Add Web Resource Transformation?", PluginModulePrompter.YN_ANSWERS, "N")).thenReturn("Y").thenReturn("N");
